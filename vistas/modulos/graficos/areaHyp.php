<div class="card card-warning">
  <div class="card-header">
     <h3 class="card-title">Área De Hyp</h3>
  ...
  <div class="card-body">
    <figure class="highcharts-figure">
        <div id="areaHyp" style="width:100%; height:350px;"></div>
    </figure>
  </div>
  <!-- /.card-body -->
</div>
...
<script type="text/javascript">
   document.addEventListener('DOMContentLoaded', function () {
        Highcharts.setOptions({
            colors: ['#FF9966','#3399FF','#33CC66', '#FF9655', '#FFF263', '#6AF9C4','#058DC7', '#50B432', '#ED561B', '#DDDF00', '#24CBE5', '#64E572','#AFEEEE','#6666CC','#CC6633','#993333',' #006600','#CC0033']
        });
        Highcharts.chart('areaHyp', {
            chart: {
                type: 'pie',
                options3d: {
                    enabled: true,
            ...
            series: [{
                ...
                data: [
                  ...
                  <?php
                     ...
                     $item = 'areaHyp';
                     $valor = '';
                     $areaHyp = ControladorEncuestas::ctrMostrarMarcas2($item,$valor);
                      $arregloMarcas = array();
                      $arregloNombreMarcas = array();
                     
                      for ($i=0; $i <count($areaHyp) ; $i++) {

                        $arregloMarcas[] =  $areaHyp[$i][0].",";
