<div class="card card-warning">
  <div class="card-header">
     <h3 class="card-title">Reparaciones Al Mes</h3>
  ...
  <div class="card-body">
    <figure class="highcharts-figure">
        <div id="reparacionesMes" style="width:100%; height:350px;"></div>
    </figure>
  </div>
  <!-- /.card-body -->
</div>
...
<script type="text/javascript">
   document.addEventListener('DOMContentLoaded', function () {
        ...
        Highcharts.chart('reparacionesMes', {
            chart: {
                type: 'pie',
                options3d: {
                    enabled: true,
            ...
            series: [{
                ...
                data: [
                  ...
                  <?php
                     ...
                     $item = 'reparacionesMes';
                     $valor = '';
                     $reparacionesMes = ControladorEncuestas::ctrMostrarMarcas2($item,$valor);
                      $arregloMarcas = array();
                      $arregloNombreMarcas = array();
                     
                      for ($i=0; $i <count($reparacionesMes) ; $i++) {

                        $arregloMarcas[] =  $reparacionesMes[$i][0].",";
