<div class="card card-warning">
  <div class="card-header">
     <h3 class="card-title">Igualados Por Semana</h3>
  ...
  <div class="card-body">
    <figure class="highcharts-figure">
        <div id="igualado" style="width:100%; height:350px;"></div>
    </figure>
  </div>
  <!-- /.card-body -->
</div>
            ...
            series: [{
                ...
                data: [
                  ...
                  <?php
                     ...
                     $item = 'igualadosPorSemana';
                     $valor = '';
                     $igualado = ControladorEncuestas::ctrMostrarMarcas2($item,$valor);
                      $arregloMarcas = array();
                      $arregloNombreMarcas = array();
                     
                      for ($i=0; $i <count($igualado) ; $i++) {

                        $arregloMarcas[] =  $igualado[$i][0].",";
