<div class="card card-warning">
  <div class="card-header">
     <h3 class="card-title">Calidad De Igualado</h3>
  ...
  <div class="card-body">
    <figure class="highcharts-figure">
        <div id="calidadDeIgualado" style="width:100%; height:350px;"></div>
    </figure>
  </div>
  <!-- /.card-body -->
</div>
...
<script type="text/javascript">
   document.addEventListener('DOMContentLoaded', function () {
        ...
        Highcharts.chart('calidadDeIgualado', {
            chart: {
                type: 'pie',
                options3d: {
                    enabled: true,
            ...
            series: [{
                ...
                data: [
                  ...
                  <?php
                     ...
                     $item = 'calidadDeIgualado';
                     $valor = '';
                     $calidadDeIgualado = ControladorEncuestas::ctrMostrarMarcas2($item,$valor);
                      $arregloMarcas = array();
                      $arregloNombreMarcas = array();
                     
                      for ($i=0; $i <count($calidadDeIgualado) ; $i++) {

                        $arregloMarcas[] =  $calidadDeIgualado[$i][0].",";
