<div class="card card-warning">
  <div class="card-header">
     <h3 class="card-title">No Encuestados</h3>
  ...
  <div class="card-body">
    <figure class="highcharts-figure">
        <div id="noEncuestados" style="width:100%; height:350px;"></div>
    </figure>
  </div>
  <!-- /.card-body -->
</div>
...
<script type="text/javascript">
   document.addEventListener('DOMContentLoaded', function () {
        ...
        Highcharts.chart('noEncuestados', {
            chart: {
                type: 'pie',
                options3d: {
                    enabled: true,
            ...
            series: [{
                ...
                data: [
                  ...
                  <?php
                     ...
                     $valor = '';
                     $noEncuestados = ControladorEncuestas::ctrMostrarMarcas2($item,$valor);
                      $arregloMarcas = array();
                      $arregloNombreMarcas = array();
                     
                      for ($i=0; $i <count($noEncuestados) ; $i++) {

                        $arregloMarcas[] =  $noEncuestados[$i][0].",";
