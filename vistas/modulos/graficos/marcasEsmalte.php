<div class="card card-warning">
  <div class="card-header">
     <h3 class="card-title">Marcas Esmalte</h3>
  ...
  <div class="card-body">
    <figure class="highcharts-figure">
        <div id="esmalte" style="width:100%; height:350px;"></div>
    </figure>
  </div>
  <!-- /.card-body -->
</div>
            ...
            series: [{
                ...
                data: [
                  ...
                  <?php
                     ...
                     $item = 'marcaEsmalte';
                     $valor = '';
                     $esmalte = ControladorEncuestas::ctrMostrarMarcas2($item,$valor);
                      $arregloMarcas = array();
                      $arregloNombreMarcas = array();
                     
                      for ($i=0; $i <count($esmalte) ; $i++) {

                        $arregloMarcas[] =  $esmalte[$i][0].",";
