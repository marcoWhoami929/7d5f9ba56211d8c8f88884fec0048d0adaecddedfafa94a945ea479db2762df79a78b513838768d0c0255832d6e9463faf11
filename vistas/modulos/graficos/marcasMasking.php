<div class="card card-warning">
  <div class="card-header">
     <h3 class="card-title">Marcas Masking</h3>
  ...
  <div class="card-body">
    <figure class="highcharts-figure">
        <div id="masking" style="width:100%; height:350px;"></div>
    </figure>
  </div>
  <!-- /.card-body -->
</div>
            ...
            series: [{
                ...
                data: [
                  ...
                  <?php
                     ...
                     $item = 'marcaMasking';
                     $valor = '';
                     $masking = ControladorEncuestas::ctrMostrarMarcas2($item,$valor);
                      $arregloMarcas = array();
                      $arregloNombreMarcas = array();
                     
                      for ($i=0; $i <count($masking) ; $i++) {

                        $arregloMarcas[] =  $masking[$i][0].",";
