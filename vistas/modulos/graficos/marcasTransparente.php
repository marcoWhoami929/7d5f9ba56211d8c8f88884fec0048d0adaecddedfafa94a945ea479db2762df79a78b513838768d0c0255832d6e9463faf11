<div class="card card-warning">
  <div class="card-header">
     <h3 class="card-title">Marcas Transparentes</h3>
  ...
  <div class="card-body">
    <figure class="highcharts-figure">
        <div id="transparente" style="width:100%; height:350px;"></div>
    </figure>
  </div>
  <!-- /.card-body -->
</div>
            ...
            series: [{
                ...
                data: [
                  ...
                  <?php
                     ...
                     $item = 'marcaTransparente';
                     $valor = '';
                     $transparente = ControladorEncuestas::ctrMostrarMarcas2($item,$valor);
                      $arregloMarcas = array();
                      $arregloNombreMarcas = array();
                     
                      for ($i=0; $i <count($transparente) ; $i++) {

                        $arregloMarcas[] =  $transparente[$i][0].",";
