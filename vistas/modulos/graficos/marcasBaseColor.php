<div class="card card-warning">
  <div class="card-header">
     <h3 class="card-title">Marcas Línea Base Color</h3>
  ...
  <div class="card-body">
    <figure class="highcharts-figure">
        <div id="baseColor" style="width:100%; height:350px;"></div>
    </figure>
  </div>
  <!-- /.card-body -->
</div>
            ...
            series: [{
                ...
                data: [
                  ...
                  <?php
                     ...
                     $item = 'marcaBaseColor';
                     $valor = '';
                     $baseColor = ControladorEncuestas::ctrMostrarMarcas2($item,$valor);
                      $arregloMarcas = array();
                      $arregloNombreMarcas = array();
                     
                      for ($i=0; $i <count($baseColor) ; $i++) {

                        $arregloMarcas[] =  $baseColor[$i][0].",";
